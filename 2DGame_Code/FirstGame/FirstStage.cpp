...
FirstStage::FirstStage() {
	...
	{
		sm->LoadMusic("bgm_music", "../music/first_stage.mp3");
		sm->PlayMusic("bgm_music");

		sm->LoadChunk("hero_attacked", "../music/attacked.wav");
		sm->LoadChunk("hero_basic_attack", "../music/basicAttack.wav");
		sm->LoadChunk("hero_comp_attack", "../music/comAttack.wav");
		sm->LoadChunk("hero_get_item", "../music/getItem.wav");
		sm->LoadChunk("hero_jump", "../music/basicAttack.wav");
		sm->LoadChunk("hero_math_attack", "../music/mathAttack.wav");

		sm->LoadChunk("monster_attack", "../music/litAttack.wav");
	}
...
void FirstStage::SettingItem() {
	...
	item.push_back(new Item(2, 405, 344));
	item.push_back(new Item(5, 565, 344));
	item.push_back(new Item(3, 715, 344));
